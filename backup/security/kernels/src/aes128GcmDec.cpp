...
#pragma HLS STREAM variable = endTagStream depth = 4
    ...
    xf::security::aes128GcmDecrypt(inStream, cipherKeyStream, IVStream, ADStream, numBitADStream, numBitInStream, endStream, outStream, numBitOutStream, tagStream, endTagStream);
