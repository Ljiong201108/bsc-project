...
#pragma HLS dataflow
	...
	mm2s(cipherTextBuffer, size, inStream, inEndStream);

	aesCbcDecrypt<128>(inStream, inEndStream, key, iv, outStream, outEndStream);

	s2mm(plainTextBuffer, outStream, outEndStream);
