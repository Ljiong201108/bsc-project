...
#pragma HLS STREAM variable = endTagStream depth = 4
    ...
    pushStream(numMessage, inBuffer, ADBuffer, numBlockInPerMessage, numBlockADPerMessage, inStream, ADStream, numByteInStream, numByteADStream, endStream);

    xf::security::aes128CcmDecrypt(inStream, cipherKeyStream, nonceStream, ADStream, numByteADStream, numByteInStream, endStream, outStream, numByteOutStream, tagStream, endTagStream);
