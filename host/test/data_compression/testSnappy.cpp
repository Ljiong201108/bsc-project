...
void testSnappyCompress3(){
	...
	ifile.open("/share/xilinx/dt_1G.txt", std::ios::binary);
	ofile.open("sample/dt_1G_3.txt.sz", std::ios::binary);
	// ifile.open("sample/sample.txt", std::ios::binary);
	// ofile.open("sample/sample.txt.sz", std::ios::binary);
...
int main(){
	testSnappy::testSnappyCompress3();
	testSnappy::testSnappyDecompress3();
}