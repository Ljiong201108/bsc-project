#include "desCfb128Enc.hpp"

extern "C"{
    void desCfb128Enc(ap_uint<64> *plainTextBuffer, ap_uint<64> cipherKey, ap_uint<64> initVec, ap_uint<64> *cipherTextBuffer, int size){
...
#pragma HLS STREAM variable = initVecStream depth = 8
        ...
        xf::security::desCfb128Encrypt(inStream, inEndStream, cipherKeyStream, initVecStream, outStream, outEndStream);
