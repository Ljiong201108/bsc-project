...
#pragma HLS STREAM variable = endTagStream depth = 4
    ...
    xf::security::aes192GcmEncrypt(inStream, cipherKeyStream, IVStream, ADStream, numBitADStream, numBitInStream, endStream, outStream, numBitOutStream, tagStream, endTagStream);
