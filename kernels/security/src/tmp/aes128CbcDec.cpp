...
#pragma HLS STREAM variable = inEndStream depth = 512
#pragma HLS STREAM variable = outStream depth = 512
#pragma HLS STREAM variable = outEndStream depth = 512
#pragma HLS STREAM variable = cipherKeyStream depth = 512
#pragma HLS STREAM variable = initVecStream depth = 512
