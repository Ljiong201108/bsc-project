...
#pragma HLS STREAM variable = endTagStream depth = 4
    ...
    xf::security::aes192CcmEncrypt(cipherStream, cipherKeyStream, nonceStream, ADStream, numByteADStream, numByteInStream, endStream, outStream, numByteOutStream, tagStream, endTagStream);
