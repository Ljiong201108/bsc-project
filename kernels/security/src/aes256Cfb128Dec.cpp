#include "aes256Cfb128Dec.hpp"

extern "C"{
    void aes256Cfb128Dec(
...
#pragma HLS STREAM variable = initVecStream depth = 16
        ...
        xf::security::aes256Cfb128Decrypt(inStream, inEndStream, cipherKeyStream, initVecStream, outStream, outEndStream);
