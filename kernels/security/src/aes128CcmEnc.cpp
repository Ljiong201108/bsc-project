...
#pragma HLS STREAM variable = endTagStream depth = 4
    ...
    xf::security::aes128CcmEncrypt(inStream, cipherKeyStream, nonceStream, ADStream, numByteADStream, numByteInStream, endStream, outStream, numByteOutStream, tagStream, endTagStream);
