...
#include "xf_utils_hw/dram_array.hpp"
...
#pragma HLS stream variable = wlist_strm depth = 256
    ...
    xf::common::utils_hw::DramArray<KEYW + PW, uram_depth, 8> uram_inst(uram_bucket);
...
#pragma HLS resource variable = t_kpld_strm_arry core = FIFO_LUTRAM
...
#pragma HLS unroll
    ...
    if (PU >= 1) {
        ...
        details::build_unit<HASHWL, KEYW, PW, ARW>(mid_k_depth_strms[0], mid_bit_num_strms[0],
                                                   ...
                                                   t_kpld_strm_arry[0], t_nm_strm_arry[0], t_bk_nm_strm_arry[0], uram_bucket);
    }
    ...
    if (PU >= 2) {
        ...
        details::build_unit<HASHWL, KEYW, PW, ARW>(mid_k_depth_strms[1], mid_bit_num_strms[1],
                                                   ...
                                                   t_kpld_strm_arry[1], t_nm_strm_arry[1], t_bk_nm_strm_arry[1], uram_bucket);
    }
    ...
    if (PU >= 4) {
        ...
        details::build_unit<HASHWL, KEYW, PW, ARW>(mid_k_depth_strms[2], mid_bit_num_strms[2],
                                                   ...
                                                   t_kpld_strm_arry[2], t_nm_strm_arry[2], t_bk_nm_strm_arry[2], uram_bucket);
        ...
        details::build_unit<HASHWL, KEYW, PW, ARW>(mid_k_depth_strms[3], mid_bit_num_strms[3],
                                                   ...
                                                   t_kpld_strm_arry[3], t_nm_strm_arry[3], t_bk_nm_strm_arry[3], uram_bucket);
    }
    ...
    if (PU >= 8) {
        ...
        details::build_unit<HASHWL, KEYW, PW, ARW>(mid_k_depth_strms[4], mid_bit_num_strms[4],
                                                   ...
                                                   t_kpld_strm_arry[4], t_nm_strm_arry[4], t_bk_nm_strm_arry[4], uram_bucket);
        ...
        details::build_unit<HASHWL, KEYW, PW, ARW>(mid_k_depth_strms[5], mid_bit_num_strms[5],
                                                   ...
                                                   t_kpld_strm_arry[5], t_nm_strm_arry[5], t_bk_nm_strm_arry[5], uram_bucket);
        ...
        details::build_unit<HASHWL, KEYW, PW, ARW>(mid_k_depth_strms[6], mid_bit_num_strms[6],
                                                   ...
                                                   t_kpld_strm_arry[6], t_nm_strm_arry[6], t_bk_nm_strm_arry[6], uram_bucket);
        ...
        details::build_unit<HASHWL, KEYW, PW, ARW>(mid_k_depth_strms[7], mid_bit_num_strms[7],
                                                   ...
                                                   t_kpld_strm_arry[7], t_nm_strm_arry[7], t_bk_nm_strm_arry[7], uram_bucket);
#ifndef __SYNTHESIS__
#ifdef DEBUG
        std::cout << "PU7 is done\n" << std::endl;
#endif
