...
#pragma HLS resource variable = key_strm core = FIFO_LUTRAM
#pragma HLS stream variable = pld_strm depth = 16
#pragma HLS resource variable = pld_strm core = FIFO_LUTRAM
#pragma HLS stream variable = e_join_pld_strm depth = 16
#pragma HLS resource variable = e_join_pld_strm core = FIFO_LUTRAM
#pragma HLS stream variable = joined_strm depth = 16
#pragma HLS resource variable = joined_strm core = FIFO_LUTRAM
#pragma HLS stream variable = e_joined_strm depth = 16
#pragma HLS resource variable = e_joined_strm core = FIFO_LUTRAM
...
//#if !defined __SYNTHESIS__ && XDEBUG == 1
    ...
    xf::database::hashMultiJoinBuildProbe<1, 64, 192, 192, 192, 0, 17, 24, CH_NM>(
